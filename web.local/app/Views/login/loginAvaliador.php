...
<div class="login-box" >
  ...
  <div class="card card-outline card-primary">
    <div class="card-header text-center">
      ...
      <p class="h1 text-rimary text-primary text-bolder nerko"><i class="fa fa-user"></i> Avaliador</p>
    </div>
    <div class="card-body bg-light">
      ...
      <form action="/web.local/public/login/paginaAvaliador" method="post">
        ...
        <div class="row">
          ...
          <div class="col-12 mt-2">
            <a role="button" href="/web.local/public/login/loginUsuario"  class="btn btn-primary btn-block">Acessar como Usuario</a>
            <a role="button" href="/web.local/public/login/index"  class="btn btn-info btn-block">Acessar como Administrador</a>
          </div>
          </div>
      </form>
